...
---
description: >-
  This release focuses on enhancing user authentication tracking and improving input validation for a better user experience.
---
# Jan 17th, 2025
...
- **Enhanced User Authentication Tracking**:
  - *Frontend*: Implemented tracking of user authentication activities for better security monitoring.
  - *Backend*: Improved monitoring of user login activities across the platform.

### Improvements

- **Input Validation Improved**:
  - *Backend*: Updated text input fields to accept only safe characters, enhancing data integrity.
- **Password Reset During Account Linking**:
  - *Backend*: Users can now reset their password when linking their account for the first time, streamlining the onboarding process.
...
<figure><img src="../.gitbook/assets/multidimensional_space.png" alt="A multidimensional Space"><figcaption><p>A multidimensional Space</p></figcaption></figure>
